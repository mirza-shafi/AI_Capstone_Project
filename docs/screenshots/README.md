...
Drop these three images in this folder (any tool — OS screenshot, browser devtools —
works; the app doesn't need to be redeployed for this). Once added, they're already
wired up: `README.md` references them by these exact filenames.

1. **`inbox.png`** — Inbox page, a High-urgency message selected, showing the queue on
